...
void editarInformacao(Cadastro *usuarios, int indice){
  ...
  do {
    ...
    switch(opcao){
      case 1:
        printf("Novo Login: ");
        scanf("%19s", usuarios[indice].login);
        break;
      case 2:
        printf("Nova Senha: ");
        scanf("%19s", usuarios[indice].senha);
        break;
      case 3:
        printf("Novo Nome: ");
        scanf("%29s", usuarios[indice].nome);
        break;
      case 4:
        printf("Novo Endereco: ");
        scanf("%49s", usuarios[indice].endereco);
        break;
      case 5:
        printf("Novo Telefone: ");
        scanf("%14s", usuarios[indice].telefone);
        break;
      case 6:
        printf("Nova Data de Nascimento: ");
        scanf("%10s", usuarios[indice].dataNascimento);
        break;
      case 7:
...
void listarUsuarios(Cadastro *usuarios, int indice) {
    printf("Nome | Endereco | Telefone | Nascimento\n\n");
